...
import {unlikeCommentItem, likeCommentItem} from '../server';

export default class Comment extends React.Component {
  constructor(props) {
    super(props);
    this.state = props.contents;
  }
  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeCommentItem(this.props.author._id, this.props.key, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeCommentItem(this.props.author._id, this.props.key, 4, callbackFunction);
      }
    }
  }
  /**
    ...
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}>{likeButtonText}</a> · <a href="#">Reply</a> · {unixTimeToString(this.props.postDate)}
          </div>
        </div>
    )
  }
